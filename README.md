...
ipl_db_Practise(1).ipynb

Jupyter Notebook containing data cleaning, exploratory analysis, visualizations, and conclusions

ipl-matches.csv

Original IPL matches dataset used for the analysis
